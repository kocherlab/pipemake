    ...
    input:
        expand(
            os.path.join(
                ...
                "PCA",
                "{model}",
                f"{config['species']}_{config['assembly_version']}.pruned.pca.eigenvec",
            ),
            model=config["models"],
        ),
        expand(
            os.path.join(
                ...
                "PCA",
                "{model}",
                f"{config['species']}_{config['assembly_version']}.pruned.pca.eigenval",
            ),
            model=config["models"],
        ),
        expand(
            os.path.join(
                ...
                "PCA",
                "{model}",
                f"{config['species']}_{config['assembly_version']}.pruned.pca.pdf",
            ),
            model=config["models"],
        ),
...
rule reseq_calc_freq_plink:
    ...
    output:
        os.path.join(
            ...
            "PCA",
            "{model}",
            f"{config['species']}_{config['assembly_version']}.pruned.afreq",
        ),
    params:
...
rule reseq_model_calc_pca_plink:
    ...
    output:
        ...
        os.path.join(
            ...
            "PCA",
            "{model}",
            f"{config['species']}_{config['assembly_version']}.pruned.pca.log",
        ),
    params:
        bed_prefix=os.path.join(
            config["paths"]["workflow_prefix"],
        ...
        pca_prefix=os.path.join(
            ...
            "PCA",
            "{model}",
            f"{config['species']}_{config['assembly_version']}.pruned.pca",
        ),
